...
public:
    ...
    std::unique_ptr<numbers_generator> clone() {
        return std::unique_ptr<numbers_generator>(this->do_clone());
    };

private:
    virtual numbers_generator* do_clone() = 0;
 };
...
public:
    ...
    std::unique_ptr<fixed_generator> clone() {
        return std::unique_ptr<fixed_generator>(this->do_clone());
    }

private:
    fixed_generator* do_clone() override {
...
public:
    ...
    std::unique_ptr<mersenne_twister_generator> clone() {
        return std::unique_ptr<mersenne_twister_generator>(new mersenne_twister_generator(*this));
    }
...
private:
    ...
    std::mt19937_64 rng;
    mersenne_twister_generator* do_clone() override {
...
public:
    ...
    int    random_int(int lower, int upper) override;
    bool   random_bool() override;
    std::unique_ptr<minstd_generator> clone() {
        return std::unique_ptr<minstd_generator>(new minstd_generator(*this));
    }
...
private:
    ...
    std::minstd_rand rng;
    minstd_generator* do_clone() override {
